...
In addition to normalization, an [online adaptive filter](https://www.ledjonbehluli.com/posts/orleans_resource_placement_kalman/) provides a smoothing effect (filters out high frequency components) and avoids rapid signal drops by transforming it into a polynomial alike decay process. This contributes to avoiding resource saturation on the silos and especially newly joined silos.
